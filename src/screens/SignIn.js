...
{/* <WavesAnimated/> */}
        ...
        <View style={{right: moderateScale(130), top: Platform.OS ? moderateScale(46) : moderateScale(60)}}>
          <EmailSvg width={18} height={15} />
        </View>
        <View style={{right: moderateScale(130), top:  Platform.OS ? moderateScale(72) : moderateScale(105)}}>
        ...
        <TouchableOpacity
          ...
          style={{
            top:  Platform.OS ? moderateScale(58) :  moderateScale(90),
